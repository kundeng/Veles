...
- [Release process](../RELEASING.md) — maintainer-only release workflow.

Design documents describe durable behavior. User guides describe the currently
implemented interface. Release notes and generated distribution artifacts are
time-bound outputs rather than design authority.
